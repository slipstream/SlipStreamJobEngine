...
class VirtualMachinesCollectJob(object):
    ...
    def _get_existing_virtual_machines(self, vm_id):
    ...
    def create_vm(self, vm_id, vm):
        ...
        try:
            ...
            if e.response.status_code == 409:
                ...
                self.update_vm(vm_id, self._get_existing_virtual_machines(vm_id), vm)
            else:
                raise e
        return cimi_vm_id
    ...
    def handle_vm(self, vm):
        ...
        exiting_vms = self._get_existing_virtual_machines(vm_id)
